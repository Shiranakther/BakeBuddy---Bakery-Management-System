...
//     // Group sales data by itemCode and sum salesQuentity as a number
...
//           salesQuentity: 0  // Initialize as number
//         };
//       }
//       acc[sale.itemCode].salesQuentity += Number(sale.salesQuentity); // Convert to number before summing
//       return acc;
//     }, {});
...
//         <h2 className="slowmoving-report-title">Smart Rebake - Slow Moving Items</h2>
...
//     // Group sales data by itemCode and sum salesQuentity as a number
//     const groupedSales = filtered.reduce((acc, sale) => {
//       // Check if the itemCode already exists in the accumulator
//       if (!acc[sale.itemCode]) {
//         acc[sale.itemCode] = {
//           itemCode: sale.itemCode,
//           itemName: sale.itemName,
//           buyerName: sale.buyerName,
//           salesQuentity: 0, // Initialize the quantity as 0
//         };
//       }
//       // Add the sales quantity to the existing quantity (convert to number)
//       acc[sale.itemCode].salesQuentity += Number(sale.salesQuentity); // Ensure it's treated as a number
//       return acc;
//     }, {});

//     // Convert the grouped sales object into an array for rendering
//     setFilteredSales(Object.values(groupedSales));
//   };
...
//             {filteredSales.map((sale) => (
//               <tr key={sale.itemCode}>
//                 <td>{new Date(sale.date).toLocaleDateString()}</td> {/* Improved date formatting */}
//                 <td>{sale.itemCode}</td>
//                 <td>{sale.itemName}</td>
//                 <td>{sale.buyerName}</td>
//                 <td>{sale.salesQuentity}</td>
