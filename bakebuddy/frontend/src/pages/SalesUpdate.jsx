      ...
      try {
        ...
        if (response.data) {
          setSalesData({
            ...
            salesQuantity: response.data.salesQuantity || "",
          });
        }
      } catch (error) {
  ...
  return (
    <div style={{ maxWidth: "600px", margin: "auto", padding: "20px", border: "1px solid #ccc", borderRadius: "10px", boxShadow: "2px 2px 12px rgba(0,0,0,0.1)" }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input type="text" name="salesQuantity" value={salesData.salesQuantity} onChange={handleChange} required style={{ width: "100%", padding: "8px", margin: "5px 0" }} />
